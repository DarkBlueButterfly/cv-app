    ...
    return (
        <div className="mockup-view" style={{width: "100%"}}>
            ...
            <div className="preview">
                ...
                <Title title={"Summary"}>
                    <p>{formData.message || 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio assumenda commodi, nulla tenetur iure excepturi id sit aperiam corporis quaerat vero alias fuga ullam perspiciatis eaque numquam consequuntur minima ea.'}</p>
                    <br />
                </Title>
                    ...
                    {experiences.map((exp) => (
                        <div key={exp.id}>
                            <div style={{display: "flex", justifyContent: "space-between"}}>
                                ...
                                <p>{exp.start ? formatted.format(new Date(exp.start)) : "???"} - {exp.end ? formatted.format(new Date(exp.end)) : "Present"}</p>
                            </div>
                            <div style={{display: "flex", justifyContent: "space-between"}}>
                ...
                <Title 
                    title={(skillsData.tech.length > 0 || skillsData.prof.length > 0 || skillsData.lang.length > 0) && "Skills"}
                    remove={(skillsData.tech.length > 0 || skillsData.prof.length > 0 || skillsData.lang.length > 0) ? false : true}
                >                
